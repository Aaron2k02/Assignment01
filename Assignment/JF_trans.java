...
public class JF_trans extends javax.swing.JFrame {
    ...
    JF_trans(String username) {
        ...
        DefaultTableModel model = new DefaultTableModel(new String[]{"Value"},0);      
...
//         Statement st1 = con.createStatement();
         ResultSet res = st.executeQuery("select * from buyer where cart = 1 ");
//         ResultSet res1 = st1.executeQuery("select  from product where cart = 1 ");
         ...
         while(res.next()){
             ...
             profitlabel.setText(String.valueOf(total));
    ...
    private void initComponents() {
        ...
        profitlabel.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
