...
public class JF_mainPage_cus extends javax.swing.JFrame {
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(48, 48, 48)
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(cartfield, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cartfield, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         dispose();
         JF_MC_electronics sc = new JF_MC_electronics(this.username);
    ...
    private void cartfieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cartfieldActionPerformed
        // TODO add your handling code here:
         dispose();
         JF_Cart1 sc = new JF_Cart1(username);
         sc.setLocationRelativeTo(null);
         sc.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
         dispose();
         JF_MC_food sc = new JF_MC_food(username);
         sc.setLocationRelativeTo(null);
         sc.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
         dispose();
         JF_MC_sport sc = new JF_MC_sport(username);
         sc.setLocationRelativeTo(null);
         sc.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String search = "%"+searchfield.getText()+"%";
         ...
         Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/omazon", "root", "PBB.v8*$z7bz#c5");
         Statement st = con.createStatement();
         ResultSet res = st.executeQuery("select product_name from product where product_name like ' "+search+" ' ");
         
             if(res.next()){
                 JOptionPane.showMessageDialog(null, "Product Found!");
                 dispose();
                 JF_search sc = new JF_search(search, this.username);
                 sc.setLocationRelativeTo(null);
                 sc.setVisible(true);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // TODO add your handling code here:
          dispose();
         JF_favourite sc = new JF_favourite(this.username);
         sc.setLocationRelativeTo(null);
         sc.setVisible(true);
